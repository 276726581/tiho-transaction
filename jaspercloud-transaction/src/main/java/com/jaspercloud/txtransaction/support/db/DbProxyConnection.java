package com.jaspercloud.txtransaction.support.db;
...
public class DbProxyConnection implements Connection {
    ...
    public void commit() throws SQLException {
        logger.debug("local commit");
    }

    @Override
    public void rollback() throws SQLException {
        logger.debug("local rollback");
    }

    @Override
    public void close() throws SQLException {
        logger.debug("local close");
    }

    public void txCommit() throws SQLException {
        logger.debug("txCommit");
        connection.commit();
    }

    public void txRollback() throws SQLException {
        logger.debug("txRollback");
        connection.rollback();
    }

    public void txClose() throws SQLException {
        logger.debug("txClose");
        connection.close();
    }
